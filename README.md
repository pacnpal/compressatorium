...
* **ISO handling toggle** (defaults to CHDMAN for `.iso`; switch to Dolphin tool)
...
- ISO info/verify and conversions follow the ISO Handling toggle in the UI (default: CHDMAN for ISO files).
