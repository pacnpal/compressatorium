...
async def test_delete_on_verify_error_messages_include_dolphin_and_3ds():
    ...
    assert "create/copy/Dolphin/3DS/Switch-compress/CSO-compress" in str(exc_info.value.detail)
    ...
    assert "create/copy/Dolphin/3DS/Switch-compress/CSO-compress" in str(create_exc.value.detail)
