...
# Default to no de-prioritization for local dev, but let a caller (or
# .env.local) override via either the new COMPRESSATORIUM_TOOL_* names or the
# legacy CHD_CHDMAN_* aliases.
export COMPRESSATORIUM_TOOL_NICE="${COMPRESSATORIUM_TOOL_NICE:-${CHD_CHDMAN_NICE:-0}}"
export COMPRESSATORIUM_TOOL_IOPRIO_CLASS="${COMPRESSATORIUM_TOOL_IOPRIO_CLASS:-${CHD_CHDMAN_IOPRIO_CLASS:-0}}"
export COMPRESSATORIUM_TOOL_IOPRIO_LEVEL="${COMPRESSATORIUM_TOOL_IOPRIO_LEVEL:-${CHD_CHDMAN_IOPRIO_LEVEL:-0}}"
